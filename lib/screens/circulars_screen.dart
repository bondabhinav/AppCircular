...
class CircularsScreen extends StatefulWidget {
  ...
  const CircularsScreen({super.key, required this.employeeId});
...
class _CircularsScreenState extends State<CircularsScreen> {
  ...
  void _onSearchChanged() {
    setState(() {
      ...
      circularsProvider?.filteredStudents = circularsProvider!
          .studentResponse!
          .aDMSTUDREGISTRATION!
          .where(
            (student) =>
                ...
                student.aDMNO!.toLowerCase().contains(
                  _searchController.text.toLowerCase(),
                ),
          )
          .toList();
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    if (model.subjectController.text.isEmpty) {
                      ...
                      model.addCircularsData(teacherId: widget.employeeId).then(
                        (value) {
                          if (value.success ?? false) {
                            ShowSnackBar.successToast(
                              context: context,
                              showMessage: 'Circular created successfully',
                            );
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              const Flexible(
                                child: Text(
                                  'Circulars Information Applicable To',
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.normal,
                                    fontFamily: "Montserrat Regular",
