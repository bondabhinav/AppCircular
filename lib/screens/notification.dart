...
class NotificationAssignment extends StatefulWidget {
  const NotificationAssignment({super.key});
...
class _NotificationAssignmentState extends State<NotificationAssignment> {
  ...
  void fetchNotifications() async {
    final url =
        'https://example.com/api/notifications'; // Replace with your API endpoint
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        CalendarPage(onDateSelected: onDateSelected),
                  ),
                );
              },
            ),
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                DetailedPage(notification: notification),
                          ),
                        );
                      },
                      child: Padding(
...
class DetailedPage extends StatelessWidget {
  ...
  const DetailedPage({super.key, required this.notification});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(notification.subtitle, style: const TextStyle(fontSize: 16)),
            const SizedBox(height: 8.0),
            Text(
