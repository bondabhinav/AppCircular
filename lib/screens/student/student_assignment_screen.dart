...
class StudentAssignmentCalenderWithList extends StatefulWidget {
  ...
  const StudentAssignmentCalenderWithList({
    super.key,
    required this.employeeId,
  });

  @override
  State<StudentAssignmentCalenderWithList> createState() =>
      _StudentAssignmentCalenderWithListState();
}

class _StudentAssignmentCalenderWithListState
    extends State<StudentAssignmentCalenderWithList> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      builder: (context, child) {
        return Consumer<StudentAssignmentProvider>(
            ...
            return Scaffold(
              ...
              body: Column(
                children: [
                  ...
                  Expanded(
                    child:
                        (model.studentAssignmentModel == null ||
  ...
  Widget listItem(
    StudentAssignmentProvider model, {
    required Assignment circular,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    DateTimeUtils.formatNextDateTime(circular.eNDDATE ?? ""),
                    style: const TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.normal,
                      fontFamily: "Montserrat Regular",
          ...
          Text(
            model.getContentAsHTML(circular.aSSIGNMENTDETAILS ?? ""),
            maxLines: 3,
