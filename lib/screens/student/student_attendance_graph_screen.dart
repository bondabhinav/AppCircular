...
class StudentAttendanceGraphScreen extends StatefulWidget {
  ...
  @override
  State<StudentAttendanceGraphScreen> createState() =>
      _StudentAttendanceGraphScreenState();
}

class _StudentAttendanceGraphScreenState
    extends State<StudentAttendanceGraphScreen> {
                        ...
                        AspectRatio(
                          ...
                          child: BarChart(
                            BarChartData(
                                ...
                                touchCallback: (event, response) {
                                  if (response != null &&
                                    ...
                                    setState(() {
                                      ...
                                      debugPrint(
                                        'response ${response.spot!.touchedBarGroupIndex}',
                                      );

                                      List<String> monthNamesList = model
                                          .studentAttendanceGraphResponse!
                                          .getMonthNamesList();

                                      String monthName =
                                          monthNamesList[response
                                              .spot!
                              ...
                              barGroups: getData(
                                model.studentAttendanceGraphResponse!,
                              ),
                              minY: 0,
                              maxY: 100,
                                  ...
                                  sideTitles: SideTitles(
                                    getTitlesWidget: (value, meta) {
                                      ...
                                      if (value.toInt() >= 0 &&
                                        ...
                                        return Text(
                                          getShortMonth(months[value.toInt()]),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  model.overAllAttendanceResponse?.attendance ==
                                          null
                                      ? const SizedBox()
                                      : Text(
