...
class StudentCircularDetailScreen extends StatefulWidget {
  ...
  @override
  State<StudentCircularDetailScreen> createState() =>
      _StudentCircularDetailScreenState();
}

class _StudentCircularDetailScreenState
    extends State<StudentCircularDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      builder: (context, child) {
        return Consumer<StudentCircularDetailProvider>(
          builder: (context, model, _) {
            return Scaffold(
              ...
              body: Container(
                ...
                child:
                    (model.studentCircularDetailResponse == null ||
                        model.studentCircularDetailResponse!.classlist ==
                            null ||
  ...
  Widget listItem({
    ...
    required StudentCircularDetailProvider model,
  }) {
    return Container(
            ...
            if (circular.lstCircularFile!.isNotEmpty)
              Column(
                ...
                children: [
                  ...
                  //     title: Text(
                  //       circular.lstCircularFile![index].fILENAME ?? "",
                  //     ),
                  //     trailing: IconButton(
                  //       onPressed: () {
                  ...
                  //     ),
                  //   ),
                  //   itemCount: circular.lstCircularFile!.length,
                  // ),
                ],
              ),
