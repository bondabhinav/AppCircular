                          ...
                          child: TableCalendar(
                            ...
                            onDaySelected: (selectedDay, focusedDay) {
                                  ...
                                  model
                                      ...
                                      ?.any((attendance) {
                                        ...
                                        return selectedDateWithoutTime
                                            .isAtSameMomentAs(attendanceDate);
                                      }) ??
                                  false;
                              ...
                              if (model.allEvents.containsKey(formattedDay)) {
                                ...
                                String eventType = eventsForDay.isNotEmpty
                                    ? eventsForDay[0].type
                                    : '';
                              ...
                              if (hasEventTypeH || isSunday) {
                                ...
                                model.getMarkedStudentAttendanceData().then((
                                  value,
                                ) {
                                  if (value!.lststud!.isNotEmpty) {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            StudentListForAttendanceScreen(
